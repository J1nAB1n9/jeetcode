...
func Test_totalFruit1(t *testing.T) {
...
func Test_totalFruit3(t *testing.T) {
	fmt.Println(totalFruit([]int{1, 2, 3, 2, 2}))
}

func Test_totalFruit4(t *testing.T) {
	fmt.Println(totalFruit([]int{3, 3, 3, 1, 2, 1, 1, 2, 3, 3, 4}))
}

func Test_totalFruit5(t *testing.T) {
	fmt.Println(totalFruit([]int{0, 1, 2}))
}

func Test_totalFruit6(t *testing.T) {
